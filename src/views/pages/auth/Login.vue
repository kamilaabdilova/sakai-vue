...
function createUser() {
//
//   const {status, error} = store.dispatch('auth/signIn', {
//     email: email,
//     password: password,
//     username: username,
      ...
      <div
        ...
        <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
          ...
          <div>
            ...
            <InputText id="username" type="text" placeholder="User Name" class="w-full md:w-30rem mb-5"
            ...
            <div class="flex align-items-center justify-content-between mb-5 gap-5">
              <div class="flex align-items-center">
                <Checkbox v-model="confirmPassword" id="rememberme1" binary class="mr-2"></Checkbox>
                <label for="rememberme1">Remember me</label>
              </div>
              <a class="font-medium no-underline ml-2 text-right cursor-pointer" style="color: var(--primary-color)">Forgot
                password?</a>
            </div>
            <Button label="Sign In" class="w-full p-3 text-xl" @click="createUser">vjhvhv</Button>
          </div>
        </div>
      </div>
    </div>
